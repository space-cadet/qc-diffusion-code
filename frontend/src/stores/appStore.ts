...
interface AppState {
  activeTab: 'simulation' | 'randomwalk' | 'gridlayout' | 'randomwalksim' | 'analysis' | 'quantumwalk' | 'quantumwalk-refactored' | 'labdemo'
  ...
  setActiveTab: (tab: 'simulation' | 'randomwalk' | 'gridlayout' | 'randomwalksim' | 'analysis' | 'quantumwalk' | 'quantumwalk-refactored' | 'labdemo') => void
