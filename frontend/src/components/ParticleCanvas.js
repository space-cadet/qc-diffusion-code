...
const GraphVisualization = ({ gridLayoutParams, graphPhysicsRef }) => {
...
const ParticleCanvasComponent = ({ gridLayoutParams, simulationStatus, particlesLoaded, tsParticlesContainerRef, boundaryRect, dimension, }) => {
...
export const ParticleCanvas = React.memo(({ gridLayoutParams, simulationStatus, tsParticlesContainerRef, particlesLoaded, graphPhysicsRef, boundaryRect, dimension, }) => {
