...
const Panel: React.FC<PanelProps> = ({ title, children, onCollapse, isCollapsed }) => (
...
const PlotConfigPanel: React.FC = () => {
...
const PlotDisplayPanel: React.FC = () => {
...
const ExportControlsPanel: React.FC = () => {
  return (
    <div className="space-y-4">
      <div>
