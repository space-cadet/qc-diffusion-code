...
export const GraphCanvas = ({ className, graph: externalGraph, defaultNodes = DEFAULT_NODES, defaultEdges = DEFAULT_EDGES, onNodeClick, onEdgeClick }) => {
    ...
    return (<div ref={containerRef} className={`w-full h-full bg-gray-50 rounded-lg shadow-inner ${className || ''}`} style={{ minHeight: '400px' }}/>);
};
