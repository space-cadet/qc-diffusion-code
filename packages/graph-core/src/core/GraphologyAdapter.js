...
export class GraphologyAdapter {
    ...
    areNodesAdjacent(sourceId, targetId, _options) {
        return this.graph.hasEdge(sourceId, targetId);
    }
    getNodeDegree(nodeId, _options) {
