...
export { multiplyMatrices, transpose, tensorProduct, eigenDecomposition, addMatrices, scaleMatrix, normalizeMatrix, isHermitian, isUnitary, orthogonalizeStateVectors } from './utils/matrixOperations';
