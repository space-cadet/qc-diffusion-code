 ...
 */
export class DensityMatrixOperator {
    constructor(matrix) {
 ...
 */
export function createDepolarizingChannel(dimension, p) {
    if (p < 0 || p > 1) {
 ...
 */
export function createAmplitudeDampingChannel(gamma) {
    if (gamma < 0 || gamma > 1) {
 ...
 */
export function createPhaseDampingChannel(gamma) {
    if (gamma < 0 || gamma > 1) {
        throw new Error('Damping parameter must be between 0 and 1');
    }
 ...
 */
export function createBitFlipChannel(p) {
    if (p < 0 || p > 1) {
        throw new Error('Probability must be between 0 and 1');
    }
 ...
 */
export function createPhaseFlipChannel(p) {
    if (p < 0 || p > 1) {
        throw new Error('Probability must be between 0 and 1');
    }
