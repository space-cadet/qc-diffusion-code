 ...
 */
export function creationOp(dimension) {
 ...
 */
export function destructionOp(dimension) {
    const matrix = Array(dimension).fill(null)
        .map(() => Array(dimension).fill(null)
        .map(() => math.complex(0, 0)));
    // Fill matrix elements
 ...
 */
export function numberOp(dimension) {
 ...
 */
export function positionOp(dimension) {
 ...
 */
export function momentumOp(dimension) {
    const aOp = destructionOp(dimension);
    const aUpOp = creationOp(dimension);
    // i(a† - a)/√2 
 ...
 */
export function harmonicOscillator(dimension) {
