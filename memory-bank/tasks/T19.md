...
- T2a: PDE boundary conditions for WebGL solver
- T5c: Strategy-agnostic boundary system in random walk physics
- T15a: Coordinate and boundary system fixes
- T12: Obstacle boundary interactions
